...
while (flag):
    ...
    contractAddress = input(Fore.LIGHTGREEN_EX + "Input Binance Smart Chain contract address: " + Fore.RESET)
    holderListResp = requests.get("https://bscscan.com/token/generic-tokenholders2?m=normal&a="+ contractAddress +"&s=100000000000000000000000000&sid=0x2859e4544c4bb03966803b044a93563bd2d0dd4d&p=1", headers=headers)
    totalSupplyResp = requests.get("https://bscscan.com/token/"+ contractAddress +"#balances", headers=headers)
