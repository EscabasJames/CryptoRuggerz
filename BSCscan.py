...
# Make it look like a legitimate request from a browser
headers = {"User-Agent":"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36"}
holderListResp = requests.get("https://bscscan.com/token/generic-tokenholders2?m=normal&a=0x94026f0227ce0c9611e8a228f114f9f19cc3fa87&s=100000000000000000000000000&sid=0x2859e4544c4bb03966803b044a93563bd2d0dd4d&p=1", headers=headers)
totalSupplyResp = requests.get("https://bscscan.com/token/0x94026f0227ce0c9611e8a228f114f9f19cc3fa87#balances", headers=headers)
...
print(newSel.xpath('.//span[contains(@class, "hash-tag text-truncate")]/@title').get())
